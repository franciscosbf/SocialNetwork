...
// Read parses a given config struct. The returned
// error (if any) comes from the config parser
func Read(vReader *envvars.VarReader, conf config.StructPtr) error {
